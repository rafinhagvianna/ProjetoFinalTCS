...
public class CatalogoServiceClientMock implements CatalogoServiceClient {
    ...
    private final Map<UUID, List<TipoDocumentoResponse>> documentosPorServico = new HashMap<>();
    ...
    public CatalogoServiceClientMock() {
        ...
        documentosPorServico.put(SERVICO_CONTA_CORRENTE_ID, Arrays.asList(
                new TipoDocumentoResponse(DOC_RG_ID, "RG"),
                new TipoDocumentoResponse(DOC_CPF_ID, "CPF"),
                new TipoDocumentoResponse(DOC_COMPROVANTE_RESIDENCIA_ID, "Comprovante de Residência")
        ));
        documentosPorServico.put(SERVICO_EMPRESTIMO_ID, Arrays.asList(
                new TipoDocumentoResponse(DOC_RG_ID, "RG"),
                new TipoDocumentoResponse(DOC_CPF_ID, "CPF"),
                new TipoDocumentoResponse(DOC_COMPROVANTE_RENDA_ID, "Comprovante de Renda")
        ));
    ...
    @Override
    public List<TipoDocumentoResponse> getDocumentosNecessariosParaServico(UUID servicoId) {
    ...
    @Override
    public ServicoResponse getServicoById(UUID servicoId) {
        ...
        return new ServicoResponse(servicoId, nome, duracao);
    }
}