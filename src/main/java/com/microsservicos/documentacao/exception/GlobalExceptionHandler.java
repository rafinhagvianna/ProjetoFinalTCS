package com.microsservicos.documentacao.exception; // Mude para o pacote desejado, ex: com.microsservicos.triagem.handler
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleGlobalException(Exception ex) {
        ...
        ErrorResponse errorResponse = new ErrorResponse(
                ...
                "Ocorreu um erro interno no servidor. Por favor, tente novamente mais tarde.", // Mensagem genérica para o cliente
                LocalDateTime.now()
        );
